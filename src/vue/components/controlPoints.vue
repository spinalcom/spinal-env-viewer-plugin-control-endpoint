...
<template>
  <div class="control-point-table">
    ...
    <md-table class="table"
      ...
      <md-table-empty-state md-label="No control point found"
                            :md-description="`No control point found.`">
        <!-- <md-button class="md-primary md-raised"
                 @click="createControlPoint">Create new control point
      </md-button> -->
      </md-table-empty-state>

      <md-table-row v-if="!editMode"
                    slot="md-table-row"
                    slot-scope="{ item }">
      ...
      <md-table-row v-else
        ...
        <md-table-cell class="tableCell"
          ...
          <md-field md-inline>
            ...
            <md-select v-model="item.dataType"
                       name="dataType"
                       id="dataType"
                       @md-selected="selectDataType(item)">
              <md-option v-for="(type,index) in Object.keys(controlPointDataType)"
                         :value="type"
                         :key="index">
        ...
        <md-table-cell class="tableCell"
          ...
          <md-field md-inline>
            ...
            <md-select v-model="item.type"
                       name="type"
                       id="type">
              <md-option v-for="(type,index) in Object.keys(endpointTypes)"
                         :value="type"
                         :key="index">
                {{ endpointTypes[type] }}
              </md-option>
        ...
        <md-table-cell class="tableCell"
          ...
          <md-field md-inline>
            ...
            <md-select v-model="item.command"
                       name="command"
                       id="command">
        ...
        <md-table-cell class="tableCell"
          ...
          <md-field md-inline>
            ...
            <md-select v-model="item.saveTimeSeries"
                       name="saveTimeSeries"
                       id="saveTimeSeries">
              <md-option :value="1">Yes</md-option>
              <md-option :value="0">No</md-option>
